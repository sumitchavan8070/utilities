...
class   AppColors {
  ...
  static const Color casper = Color(0xFFB2BCCA);
  static const Color lavenderPinocchio = Color(0xFFE0E0E0);
  static const whiteFrost = Color(0xffD9E7FF);
  static const whiteSmoke2 = Color(0xFFF2F6F9);
  ...
  static const blackEel20 = Color(0x33444444);
  static const silverChalice = Color(0xFFAAAAAA);
  static const silverChalice30 = Color(0x4DAAAAAA);
  static const lavenderMist = Color(0xFFDDEBFF);
  static const monsoon = Color(0xFF898989);
  ...
  static const Color iron98 = Color(0xFFCED4DA);
  static const Color paleSky = Color(0xFF6E717C);
  static const Color paleSky80 = Color(0xFF6B7280);
  static const Color stormGrey = Color(0xFF697386);
  static const Color santaGrey = Color(0xFF9CA3AF);
  static const Color ebonayClay = Color(0xFF1F2A37);
  static const Color mirage = Color(0xFF111928);
  ...
  static const Color paleSky30 = Color(0x4D6E717C);
  static const Color boulder = Color(0xFF747579);
  ...
  static const lightRed = Color(0xFFFA5252);
  static const lightGrey = Color(0xFFDCD9D9);
  ...
  static const Color warmBlue = Color(0xFF4C4DDC);
  static const Color ultramarineBlue = Color(0xFF5570F1);
  static const Color ultramarineBlue80 = Color(0xFF4B60F0);
  static const Color blueHaze = Color(0xFFB6C2E2);
  static const Color lightPeriwinkle = Color(0xFFC8C8F4);
  static const Color linkWater = Color(0xFFD2E9FF);
...
// IELTS Dashboard
  ...
  static const Color mistBlueLight = Color(0xFF696984);
...
//   Study Abroad
  ...
  static const carbonGrey = Color(0xFF5B5B5B);
